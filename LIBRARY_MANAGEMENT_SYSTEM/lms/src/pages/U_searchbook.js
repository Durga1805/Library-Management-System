...
const U_searchbook = () => {
  ...
  const handleSearch = () => {
    ...
    navigate(`/U_books?searchType=${searchType}&query=${searchQuery}`);
  };
  ...
  const handleTabClick = (tab) => {
    ...
    if (tab === 'UPeriodicals') {
      ...
      navigate('/userch'); // Navigate to the books page or the default page
    }
  };
      ...
      >
        ...
        <div className="flex mb-4">
          <button
            ...
            className={`text-lg font-semibold py-2 px-6 ${
              activeTab === 'userch' ? 'bg-gray-300 text-blue-600' : 'bg-gray-200'
        ...
        <div className="p-6 bg-white rounded-lg shadow-md w-full max-w-xl flex items-center space-x-4">
          ...
          >
            ...
            <option>Search by Call No</option>
          </select>
